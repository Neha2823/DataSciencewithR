...
# Remove repeated terms in all most all documents
...
setup_twitter_oauth("2NFD2caK5La9WAYR1FBb2Gdar", 
                    ...
                    "2722336712-17wtqiukD6XW39Upv5AqkL5SKSkrTAKqf8KPACL", # Access token
                    "bYV7isrqGDJrvxuDpeZrSPLCpMhNMxZTZeK13qptDNFFa")  #
